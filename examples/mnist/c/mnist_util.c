...
// Loading data borrowed from
// https://github.com/ooki/green_tsetlin/blob/master/generator_tests/mnist_test.c
...
void evaluate_models(struct TsetlinMachine *tm, struct SparseTsetlinMachine *stm,
					 struct StatelessTsetlinMachine *sltm, uint8_t *x_data,
					 int32_t *y_data, uint32_t rows) {
...
void train_models(struct TsetlinMachine *tm, struct SparseTsetlinMachine *stm,
				  uint8_t *x_data, int32_t *y_data, uint32_t rows) {
